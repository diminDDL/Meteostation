...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox2->Items->AddRange(gcnew cli::array< System::Object^  >(27) {
				L"UTC±00:00 ", L"UTC+01:00 ", L"UTC+02:00 ", L"UTC+03:00 ",
					L"UTC+04:00 ", L"UTC+05:00 ", L"UTC+06:00 ", L"UTC+07:00 ", L"UTC+08:00 ", L"UTC+09:00 ", L"UTC+10:00 ", L"UTC+11:00 ", L"UTC+12:00 ",
					L"UTC+13:00 ", L"UTC+14:00 ", L"UTC−01:00 ", L"UTC−02:00 ", L"UTC−03:00 ", L"UTC−04:00 ", L"UTC−05:00 ", L"UTC−06:00 ", L"UTC−07:00 ",
					L"UTC−08:00 ", L"UTC−09:00 ", L"UTC−10:00 ", L"UTC−11:00", L"UTC−12:00"
			});
	...
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (WifiSSID->Length > 32) {
			...
			if (this->serialPort1->IsOpen) {
				...
				this->progressBar1->Increment(5);	
				Sleep(300);
				this->serialPort1->Close();	//close port
